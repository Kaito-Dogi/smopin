...
import app.kaito_dogi.smopin.shared.database.firestore.firebase.DefaultSmokingAreaFirestoreSdkWrapper
...
abstract class DatabaseFirestoreBindingContainer private constructor() {
  ...
  @Binds
  internal abstract val DefaultSmokingAreaFirestoreSdkWrapper.binds: SmokingAreaFirestoreSdkWrapper
}
